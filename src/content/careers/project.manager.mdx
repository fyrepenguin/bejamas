...
<p className="desc">
  Success of every JAMstack or Progressive Web App project we have lies in the
  hands of a Project Manager. If you want to lead a team of developers and make
  significant impact on our deliveries, read on further.
</p>
As a Project Manager at Bejamas your responsibility will be, in short, to coordinate
our developers and processes to ensure that our projects are delivered on time to
our customers and produce the desired results for them.
