...
<p className="desc">
  If 'good enough' design implementations aren’t good enough for you and you
  feel anxious when you see red and yellow lighthouse results then don't
  contemplate any longer about applying for this position.
</p>
